...
$(document).ready(function() {
    ...
    $('.category-item').click(function() {
        ...
        $('#selectedCategory').val(selectedCategory); // 실제 서버로 전송될 값 설정
    });
    
    $('.category-item2').click(function() {
        var selectedCategory2 = $(this).data('category2');
        $('#f_id').val(selectedCategory2); // 사용자에게 선택된 카테고리 보여주기
        $('#selectedCategory2').val(selectedCategory2); // 실제 서버로 전송될 값 설정
    });
                              ...
                              <!-- 제품 코드 -->
                                ...
                                <!-- 드롭다운 -->
							        ...
							        <div class="form-group">
							          ...
							          <input type="text" class="form-control" id="pro_midcategory" name="pro_midcategory" readonly>
										</div> 
							        ...
							        <div class="dropdown">
							            ...
							            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
							                <c:forEach var="f" items="${fList}">
							                    <li class="dropdown-item category-item2" data-category2="${f.f_id}">${f.f_id}</li>
							                </c:forEach>
							            </ul>
							        </div>
