...
<body>
    ...
    <div class="comm-body container-fluid py-4"> <!-- 메인 바디 -->
	 ...
	 <div class="buyDetail">
	 <label class="buyDetailLabel">판매 등록</label>
	 	...
	 	<div class="form-group" id="titleBox1">
		    ...
		    <input class="form-control" id="buy_title" name="buy_title" placeholder="판매전표_YYYYMMDD_거래처명" />
		...
		<div class="colNote">비고</div>
			 ...
			 <button type="submit" class="btn btn-primary" id="buyApplyBtn">판매 등록</button>
