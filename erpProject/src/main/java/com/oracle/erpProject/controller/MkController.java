...
public class MkController {
	...
	//제품 조회, 수정
	@GetMapping("/productR")
	public String productR(MK_Product product,Model model) {
		System.out.println("MK Controller productR Start...");
		  List<MK_Product> listProduct = mk_Service_interface.listProduct(product);
	...
	public MK_Product productDetail(@RequestParam("p_itemcode") int itemCode ,MK_Product product, Model model ) {
